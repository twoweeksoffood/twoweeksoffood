...
async function enhanceApp(ctx) {
  ...
  return App => props => ctx.sheets.collectStyles(__jsx(React.Fragment, null, __jsx(Global, null), __jsx(App, props)));
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("icA4");
...
class Document extends _react.Component {
  ...
  */
  static async getInitialProps(ctx) {
    const enhancers =  true ? await Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__("wy51"))).then(mod => mod.default(ctx)) : undefined;
    ...
    const styles = [...(0, _server.default)(), ...( true ? await Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__("942T"))).then(mod => mod.default(ctx)) : undefined)];
    return {
      html,
      head,
      styles
...
Document.headTagsMiddleware =  true ? Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__("zJFg"))) : undefined;
Document.bodyTagsMiddleware =  true ? Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__("cJ5G"))) : undefined;
Document.htmlPropsMiddleware =  true ? Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__("+1hA"))) : undefined;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("/BPb");
