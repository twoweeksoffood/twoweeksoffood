...
/***/ "./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-enhance-app-server.js":
/*!********************************************************************************************************!*\
  !*** ./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-enhance-app-server.js ***!
  \********************************************************************************************************/
...
var _jsxFileName = "/home/henry/stuff/git/twoweeksoffood/node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-enhance-app-server.js";
...
async function enhanceApp(ctx) {
  ...
  return App => props => ctx.sheets.collectStyles(__jsx(React.Fragment, {
    __self: this,
    __source: {
...
/***/ "./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-get-styles-server.js":
/*!*******************************************************************************************************!*\
  !*** ./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-get-styles-server.js ***!
  \*******************************************************************************************************/
/*! no static exports found */
...
async function getStyles(ctx) {
  const styleElement = ctx.sheets.getStyleElement(); // Seal the stylesheet to prevent memory leaks
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-enhance-app-server */ "./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-enhance-app-server.js");
/* harmony import */ var _home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0__);

    

    /* harmony default export */ __webpack_exports__["default"] = (function (ctx) {
      return Promise.all([_home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_enhance_app_server__WEBPACK_IMPORTED_MODULE_0___default()(ctx, {})])
    });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-get-styles-server */ "./node_modules/@explodingcamera/next-plugin-styled-components/src/unstable-get-styles-server.js");
/* harmony import */ var _home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0__);

    

    /* harmony default export */ __webpack_exports__["default"] = (function (ctx) {
      return Promise.all([_home_henry_stuff_git_twoweeksoffood_node_modules_explodingcamera_next_plugin_styled_components_src_unstable_get_styles_server__WEBPACK_IMPORTED_MODULE_0___default()(ctx, {})])
    });
...
class Document extends _react.Component {
  ...
  */
  static async getInitialProps(ctx) {
    const enhancers =  true ? await Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__(/*! next-plugin-loader?middleware=unstable-enhance-app-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=unstable-enhance-app-server!./"))).then(mod => mod.default(ctx)) : undefined;
    ...
    const styles = [...(0, _server.default)(), ...( true ? await Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__(/*! next-plugin-loader?middleware=unstable-get-styles-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=unstable-get-styles-server!./"))).then(mod => mod.default(ctx)) : undefined)];
    return {
      html,
      head,
      styles
...
Document.headTagsMiddleware =  true ? Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__(/*! next-plugin-loader?middleware=document-head-tags-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=document-head-tags-server!./"))) : undefined;
Document.bodyTagsMiddleware =  true ? Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__(/*! next-plugin-loader?middleware=document-body-tags-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=document-body-tags-server!./"))) : undefined;
Document.htmlPropsMiddleware =  true ? Promise.resolve().then(() => _interopRequireWildcard(__webpack_require__(/*! next-plugin-loader?middleware=document-html-props-server */ "./node_modules/next/dist/build/webpack/loaders/next-plugin-loader.js?middleware=document-html-props-server!./"))) : undefined;
